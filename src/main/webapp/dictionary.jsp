			...
			<div class="layui-col-md12">
				<div class="layui-card">
					...
					<div class="layui-card-body layui-table-body layui-table-main">
						<table class="layui-table layui-form" id="showDictionary"
							lay-filter="showDictionary"></table>
					</div>
					...
					function() {
						...
						table.on('tool', function(obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
							...
							if (layEvent === 'del') { //删除
								...
								xadmin.open('修改条目','dictionary-edit.jsp?id='+data.id,'600','500');
							}
							return false;
						});
...
<script type="text/html" id="barDemo">
	  <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="upt">编辑</a>
